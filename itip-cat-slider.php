...
function replacing_template_loop_product_thumbnail() {
	...
	function itip_wc_template_loop_product_replaced_thumb() {
		...
		if ( $additional_image_url && is_product_category() ) {
			echo '<img width="" height="" src="' . $additional_image_url . '" class="overlay-content" alt="" decoding="async" loading="lazy">';
		} else {

		}
	}
	add_action( 'woocommerce_before_shop_loop_item_title', 'itip_wc_template_loop_product_replaced_thumb', 10 );
}
